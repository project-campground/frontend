...
export default function ProfilePostCreator({ placeholder, onPost, sx }: Props) {
            ...
            <CardContent>
                {open
                    ? <Group gap={1.5} alignItems="center">
                        <UserAvatar withStatus did={account.sessionInfo.did} avatar={account.profile.avatar} size="lg" />
                    ...
                    : <Link overlay underline="none" component="button" level="body-md" onClick={() => setOpen(!open)} gap={1.5} color="neutral" startDecorator={<UserAvatar withStatus did={account.sessionInfo.did} avatar={account.profile.avatar} size="lg" />}>
