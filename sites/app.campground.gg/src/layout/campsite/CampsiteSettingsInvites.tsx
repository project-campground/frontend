                    ...
                    columns={[
                        {
                            id: "id",
                            name: (
                                <FormattedMessageGlobal id="app.invites.code" />
                            ),
                        ...
                        },
                        {
                            id: "createdBy",
                            name: (
                                <FormattedMessageGlobal id="app.common.createdBy" />
                            ),
                            width: 240,
                        ...
                        },
                        {
                            id: "expires",
                            name: (
                                <FormattedMessageGlobal id="app.common.expiresAt" />
                            ),
                            width: 120,
                        ...
                        },
                        {
                            id: "maxUses",
                            name: (
                                <FormattedMessageGlobal id="app.invites.allowedAmount" />
                            ),
                            width: 120,
...
function CreatedByComponent({
    item: invite,
}: {
    item: CampsiteInviteViewBasic;
}) {
...
function CreatedAtComponent({
    ...
    return <Datestamp long date={new Date(invite.createdAt)} />;
}
function MaxUsesComponent({ item: invite }: { item: CampsiteInviteViewBasic }) {
    return (
        ...
        >
            {invite.allowedAmount ?? (
                <FormattedMessageGlobal id="common.infinite" />
            )}
        </Typography>
    );
}
