...
export default function LoginPage() {
    ...
    const onSubmit = async (event: React.MouseEvent<Element, MouseEvent> | undefined, fieldValues: Record<string, any>) => {
            ...
            <FormSection>
                ...
                <FormControl required>
                    ...
                    <FormFieldText
                        ...
                        />
                    <FormHelperText>
                        <Link color="neutral" textColor="neutral.300" level="body-md" href="/reset-password">
                            <FormattedMessage
