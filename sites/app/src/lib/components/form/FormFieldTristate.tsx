...
export interface FormFieldTristateProps
	extends FormFieldProps<TristateValue>, FormFieldDecoratorProps {
	label?: ReactNode[] | ReactNode;
	description?: ReactNode[] | ReactNode;
	design?: TristateType;
}

type State = { value: TristateValue };

export default class FormFieldTristate extends AbstractFormField<
	TristateValue,
	FormFieldTristateProps,
	State
> {
