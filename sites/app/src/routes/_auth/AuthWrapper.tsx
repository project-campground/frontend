	...
	render() {
		...
		return (
			<Stack
				component='main'
				direction='column'
				className='LandingBareboneWrapper container'
				sx={{ height: '100%', ...sx }}
			>
				<AuthNavbar page='home' />
				<Stack
					direction='column'
					className='SigninWrapper body'
					sx={{ overflow: 'hidden', height: '100%', flex: 1, width: '100%', ...bodySx }}
				>
					<Box
						className='SigninPage background'
						sx={(theme) => ({
							position: 'absolute',
							top: 0,
							left: 0,
					...
					>
						<Box
							className='SigninPage background-dark'
							sx={(theme) => ({
					...
					<Box
						className='SigninWrapper wrapper-column'
						sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', height: '100%' }}
					>
						<Box
							className='SigninWrapper wrapper-row'
							sx={{ display: 'flex', alignItems: 'center', height: '100%', flexDirection: 'row' }}
						>
							<Sheet
								className='SigninWrapper box'
								sx={(theme) => ({
							...
							>
								<Stack
									className='SigninWrapper form-wrapper'
									gap={2}
									sx={{ px: 12, py: 10 }}
								>
									<Stack
										className='SigninWrapper header'
										direction='row'
									>
										<Typography level='h3'>
									...
									<Box className='SigninWrapper form-container'>{children}</Box>
								</Stack>
							</Sheet>
						</Box>
					</Box>
