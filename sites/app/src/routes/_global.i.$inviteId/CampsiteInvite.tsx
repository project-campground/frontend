...
export default function CampsiteInvite({
	invite: { campsite },
	inviteId,
	domain,
}: {
	inviteId: string;
	domain: string;
	invite: CampsiteInviteViewDetailed;
}) {
	const session = useSession();
	const navigate = useNavigate();
	const [error, setError] = useState<HttpResponseError | null>(null);
	const onAccept = () =>
		session.atproto.invitesGlobal.use(domain, inviteId).then((resp) => {
