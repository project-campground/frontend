...
const TentMessageDividerStack = styled(Box, { name: 'TentMessageDivider', slot: 'root' })<{
...
type Props = React.PropsWithChildren & { color?: ColorPaletteProp };
	...
	return (
		<TentMessageDividerStack color={color ?? 'neutral'}>
			<Divider
				...
				className='TentMessageDivider-divider divider-left'
			/>
			{children}
			<Divider
				orientation='horizontal'
				className='TentMessageDivider-divider divider-right'
			/>
