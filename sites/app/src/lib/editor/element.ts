...
export const EditorItemToParent: Record<
	EditorItemElementType,
	EditorBlockElementType | EditorInlineElementType | EditorItemElementType
> = {
...
export const EditorItemParents: Record<
	EditorItemElementType,
	(EditorBlockElementType | EditorInlineElementType | EditorItemElementType)[]
> = {
	'code-line': ['code-block'],
 ...
 */
export interface EditorBlockElementBase<
	TType extends EditorBlockElementType | EditorItemElementType,
	TDescendant,
> {
	type: TType;
...
export type EditorItemElement = EditorCodeLine | EditorListItem | EditorTableRow | EditorTableCell;
