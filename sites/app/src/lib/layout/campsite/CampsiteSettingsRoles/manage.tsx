...
export default function RolePageManage({
	role,
	onRoleDelete,
}: {
	role: RoleView;
	onRoleDelete: (role: RoleView) => unknown;
}) {
		...
		<Stack>
			<Box>
				...
				{isDefaultRole && (
					...
					>
						This role cannot be deleted, as it is the default member role for this campsite.
					</Alert>
				)}
			</Box>
			<ContentDeleteModal
