...
export const globalLocale = defineMessages({
	...
	'site.people': {
		...
		description: 'People list header/link',
	},
	'site.campground': {
		id: 'site.campground',
		defaultMessage: 'Campground',
		description: "Campground header. This can be used to convert 'Campground' to local script",
	},

	'site.api': { id: 'site.api', defaultMessage: 'API', description: 'Campground API header' },
	'site.docs': {
		id: 'site.docs',
		defaultMessage: 'Docs',
		description: 'Documents header abbreviated',
	},

	'site.social': { id: 'site.social', defaultMessage: 'Socials', description: 'Socials header' },
	'site.social.bsky': {
		id: 'site.social.bsky',
		defaultMessage: 'Bluesky',
		description: 'Bluesky social header',
	},
	'site.social.atprotocol': {
		id: 'site.social.atprotocol',
		defaultMessage: 'ATProtocol',
		description: 'ATProtocol protocol header',
	},
	'site.social.github': {
		id: 'site.social.github',
		defaultMessage: 'GitHub',
		description: 'GitHub social header',
	},
	'site.social.discord': {
		id: 'site.social.discord',
