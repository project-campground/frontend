...
export interface FormFieldNumberProps
	extends FormFieldProps<number | null>, FormFieldDecoratorProps {
	placeholder?: string;
	min?: number;
	max?: number;
	incrementBy?: number;
...
type State = { textValue: string; value: number | null };

export default class FormFieldNumber extends AbstractFormField<
	number | null,
