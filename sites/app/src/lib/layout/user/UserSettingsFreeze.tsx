...
export default function UserSettingsFreeze({}: SettingsComponentProps<{}>) {
	...
	const onFreeze = () =>
		session.atproto.account.deactivate({}).then((resp) => {
					...
					{deactivated ?
						...
						>
							<FormattedMessage
								...
								values={{ buttonText: <FormattedMessageGlobal id='app.users.settings.reactivate' /> }}
							/>
						</Alert>
					:	<Alert
							variant='soft'
						...
						>
							<FormattedMessage
								...
								values={{ buttonText: <FormattedMessageGlobal id='app.users.settings.deactivate' /> }}
							/>
						</Alert>
					}
				</FormSection>
				...
				<FormSection>
					...
					>
						<FormattedMessageGlobal
							id={deactivated ? 'app.users.settings.reactivate' : 'app.users.settings.deactivate'}
						/>
					</FormSubmit>
				</FormSection>
			</Form>
