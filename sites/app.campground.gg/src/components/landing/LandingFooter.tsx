...
export default class LandingFooter extends React.Component<Props> {
    ...
    render() {
        return (
            <Stack direction="column" className="LandingFooter container landing-side-padding" gap={2.5}>
                <BrandLogo includeText size="xl" />
                <Grid container sx={{ display: "grid", gridTemplateColumns: `1fr 1fr 1fr 1fr`}} className="LandingNavbar menu" spacing={8}>
