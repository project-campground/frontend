...
export const clientMiddleware: Route.ClientMiddlewareFunction[] = [loginRequiredMiddleware];
...
export default function Index({ params: { campId } }: Route.ComponentProps) {
	...
	if (campIdSplit.length > 2)
		return (
			<PagePlaceholder
				icon={PagePlaceholderIcon.NotOk}
				title={
					<FormattedMessage
	...
	return (
		<CampsiteLayout
			...
			backendDomain={backendDomain || defaultBackendDomain}
			navigate={navigate}
		>
			<Outlet />
		</CampsiteLayout>
