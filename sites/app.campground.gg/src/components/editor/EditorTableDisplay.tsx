...
const EditorTableDisplay = styled("table", {
...
const EditorRowAdderWrapper = styled("div", {
    name: "EditorRowAdder",
    slot: "root"
})(() => ({
    position: "absolute",
...
const EditorRowAdderDisplay = styled("div", {
    name: "EditorRowAdder",
    slot: "display"
})(({ theme }) => ({
    position: "relative",
...
const EditorColumnAdderWrapper = styled("div", {
    name: "EditorColumnAdder",
    slot: "root"
})(() => ({
    position: "absolute",
    height: "100%",
...
const EditorColumnAdderDisplay = styled("div", {
    name: "EditorColumnAdder",
    slot: "display"
})(({ theme }) => ({
    position: "relative",
