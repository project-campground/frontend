...
const DividerBase = styled(`div`, { name: 'Divider', slot: 'root' })(({ theme }) => ({
	position: 'relative',
	display: 'flex',
...
const DividerDot = styled(`span`, { name: 'DividerDot' })(({ theme }) => ({
	backgroundColor: theme.vars.palette.neutral[400],
	width: 8,
	height: 8,
	borderRadius: theme.vars.radius.sm,
	'.selected > &': { backgroundColor: theme.vars.palette.primary[500] },
}));
