...
export interface FormFieldObjectProps extends PropsWithChildren, FormFieldProps<number> {
	gap?: number;
	inline?: boolean;
}

type State = { value: number; valid: Record<number, boolean> };

export default class FormFieldFlags extends AbstractFormField<number, FormFieldObjectProps, State> {
